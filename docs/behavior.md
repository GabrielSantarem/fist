...
*   **Automatic Decoding:** Dynamic parameter tokens and wildcard captures are percent-decoded on ingress (e.g., `/user/Jo%C3%A3o` extracts `"João"`, `/tags/c%2B%2B` extracts `"c++"`).
